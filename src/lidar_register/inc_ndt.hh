...
public:
  ...
  IncNdt(double voxel_size, bool near_search, int max_capacity,
         int min_effective_pts, int min_pts_in_voxel, int max_pts_in_voxel,
         double res_outlier_thresh, double eps, bool calib_lidar2imu);
  ~IncNdt();
   ...
   * @param HTVr
   */
  void ComputeResidualAndJacobians(State &nav_state,
