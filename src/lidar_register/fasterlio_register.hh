...
class FasterlioRegister : public LidarRegister {
   public:
    ...
    using PointVector = std::vector<PointXYZI, Eigen::aligned_allocator<PointXYZI>>;
    FasterlioRegister(const std::shared_ptr<SystemConfig> &system_config, std::shared_ptr<IESKF> kf_ptr);
