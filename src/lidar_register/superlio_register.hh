...
public:
  ...
  SuperLIORegister(const std::shared_ptr<SystemConfig> &system_config,
...
private:
  ...
  bool compute_error(const std::array<double, 4> &abcd, const V3D &point,
                     const float length, double &error);
