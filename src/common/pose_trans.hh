...
public:
  ...
  PoseTrans inverse() const { return PoseTrans(R.inverse(), -R.inverse() * t); }
  ...
  const Eigen::Quaterniond eigen_q() const { return Eigen::Quaterniond(R); }
