...
struct EncoderConfig {
  ...
  void print() const {
    ...
    LOG_INFO("  encoder_position_noise_std: {:03.3f}",
             encoder_position_noise_std);
    LOG_INFO("  encoder_rotation_noise_std: {:03.3f}",
             encoder_rotation_noise_std);
...
struct LocalizerConfig {
  ...
  void print() const {
    ...
    LOG_INFO("  update_search_dist_thresh: {:03.3f}",
             update_search_dist_thresh);
...
public:
  ...
  PoseTrans LoadTransformAndPrint(const YAML::Node &node,
