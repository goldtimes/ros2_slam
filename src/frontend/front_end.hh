...
public:
  ...
  FrontEndStatus getFrontEndStatus() { return front_end_status_; }

  const double GetCurentTime() const { return measure_group_.lidar_beg_time; }
  ...
  const PoseTrans GetTransformEncodeToWorld() const { return T_WE; }
